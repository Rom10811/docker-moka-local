...
odoo.define('pos_product_bundle_pack.pos', function(require) {
    ...
    models.PosModel = models.PosModel.extend({
        initialize: function (session, attributes) {
            ...
            //console.log("product_model loadedddddddddddddddddddddddddddddddddddd",product_model);
    ...
    models.load_models({
        ...
        loaded: function(self, pos_product_pack) {
            ...
            //console.log("***************self.pos_product_packkkkkkkkkkkkkkkkkkkkkkkkkkkk", self.pos_product_pack);
        },
    });
    ...
    models.Orderline = models.Orderline.extend({
        ...
        get_product_bundle_pack: function() {
            ...
            for (var i = 0; i < pos_products.length; i++) {
            	//console.log("#####################pos_products[i].id",pos_products[i].id == product.id)
                if (pos_products[i].id == product.id && (pos_products[i].pack_ids).length > 0) {
                    ...
                    //console.log("bundle_product_items(((((((((()))))))))))))))",pos_product_bundle_pack)
